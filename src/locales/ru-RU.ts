...
"remain": "Осталось:",
  ...
  "infoStar": "Этот проект с открытым исходным кодом находится на <a class=\"text-blue-600 dark:text-blue-500\" href=\"https://api.raojialong.space/\" target=\"_blank\">RJLAPI</a>, </p><p>спасибо!",
